...
public class FaceRecognition extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.facerecongnition);
    ...
    private class SavePicRunnable implements Runnable {
        ...
        public void run() {
          //  saveFacePicToLocal(bitmap);
            ...
            // bitmap.compress()
            String num=okhttp.okhttpPostFile_forBytes("http:/192.168.0.112:8000/login/register/",baos.toByteArray());
        if(num!="YES")
        {
            Log.e("", "run: "+num);
           // Log.e("run: sndk", "fsejf");
            sleep(1000);
           // isSavingPic = false;
        }
        }
